...
+ (UIColor*)colorOfLoginBackground{
    //return [UIColor colorWithRed:125/256.0f green:206/256.0f blue:240/256.0f alpha:1.0];
    return [UIColor colorWithRed:182/256.0f green:255/256.0f blue:171/256.0f alpha:1.0];
}
...
+ (UIColor*)colorOfURLUserPassword{
    ...
    return [UIColor colorWithRed:140/256.0f green:255/256.0f blue:228/256.0f alpha:1.0];
}
//ios_credentials_info_color
...
+ (UIColor*)colorOfLoginErrorText{
    //return [UIColor whiteColor];
    return [UIColor colorWithRed:51/256.0f green:255/256.0f blue:221/256.0f alpha:1.0];
}
//ios_server_connection_info_color
//Text color of server error
+ (UIColor*)colorOfServerErrorText{
    //return [UIColor whiteColor];
    return [UIColor colorWithRed:48/256.0f green:41/256.0f blue:255/256.0f alpha:1.0];
}
