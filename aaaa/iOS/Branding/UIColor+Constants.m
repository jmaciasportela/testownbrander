...
+ (UIColor*)colorOfLoginBackground{
    //return [UIColor colorWithRed:125/256.0f green:206/256.0f blue:240/256.0f alpha:1.0];
    return [UIColor colorWithRed:69/256.0f green:255/256.0f blue:205/256.0f alpha:1.0];
}
...
+ (UIColor*)colorOfURLUserPassword{
    ...
    return [UIColor colorWithRed:135/256.0f green:223/256.0f blue:255/256.0f alpha:1.0];
}
//ios_credentials_info_color
...
+ (UIColor*)colorOfServerErrorText{
    //return [UIColor whiteColor];
    return [UIColor colorWithRed:166/256.0f green:231/256.0f blue:255/256.0f alpha:1.0];
}
